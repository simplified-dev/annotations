 ...
 * Erased names throughout, because the two models spell an applied type
 * differently and the questions asked of it are about identity rather than
 * arguments.
 *
 ...
 * @param writtenSuperType the erased name written in the extends clause, or null when none is written
