 ...
 */
public class LazyAugmentProviderTest extends BasePlatformTestCase {
    ...
    public void testLazyGetterSynthesized() {
        ...
        assertEquals("return type matches the source field type",
            "java.lang.String", getter.getReturnType().getCanonicalText());
